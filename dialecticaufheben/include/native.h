...
NtCreateSection (
    ...
    _In_ ULONG DesiredAccess,
    _In_ OPTIONAL void* ObjectAttributes,
...
//another phantomdll change forestorr 2025 shit idk why he did this
//NtCreateSection (
...
//phantomdll forestorr change (sometime in 2025 iunno)
